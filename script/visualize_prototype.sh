...
python ./vis_utils/find_topk_response.py --case_name Shapes_test --model ResNet --basic_model resnet50_relu --concept_per_layer 8 16 32 64 --cha 32 32 32 32 --device 1 --eigen_topk 1
